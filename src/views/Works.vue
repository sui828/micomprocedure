  ...
  <div class="container">
      <header>
        <div class="header-box">
          ...
          <nav class="navi">
            <ul class="menu-box">
              <li class="menu-item"><input type="button" id="scroll-1" value="FRESHMAN"></li>
              <li class="menu-item"><input type="button" id="scroll-2" value="SENIOR"></li>
            </ul>
            <ul class="menu-box2">
              <li class="menu-item2"><input type="button" id="scroll-1" value="新入生プロジェクト"></li>
              <li class="menu-item2"><input type="button" id="scroll-2" value="その他"></li>
            </ul>
          </nav>
        </div>
      </header>
  <div class="works">
    ...
    <div class="works-box">
      ...
      <div class="works-content">
        ...
        <a href="#" class="disabled">
          <div class="works-mask">
            <div class="works-caption">Team C no game</div>
          </div>
        </a>
      </div>
      <div class="works-content">
